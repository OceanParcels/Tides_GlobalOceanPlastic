# -*- coding: utf-8 -*-
"""
Computing the mean separation (averaged over all particle pairs) as a function of time
...
savefile = '/science/projects/oceanparcels/output_data/data_Miriam/MeanSeparationTime'
