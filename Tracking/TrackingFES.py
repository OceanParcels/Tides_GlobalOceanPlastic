# -*- coding: utf-8 -*-
"""
Tracking particles across the globe with FES data for M2+S2+K1+O1 tidal field
...
outputfile = pset.ParticleFile(name = "/science/projects/oceanparcels/output_data/data_Miriam/Results_TrackingFES.nc")
