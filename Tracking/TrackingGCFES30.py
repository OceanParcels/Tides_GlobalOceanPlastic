...
with tides only for 30 days (~2x spring-neap cycle)
...
outputfile = pset.ParticleFile(name = "/science/projects/oceanparcels/output_data/data_Miriam/Results_TrackingGCFES30.nc")
