# -*- coding: utf-8 -*-
"""
Tracking particles across the globe with GLobCurrent data and FES data for M2+S2+K1+O1 tidal field, particle spacing 0.5 degrees
...
totalKernel = AdvectionRK4 + pset.Kernel(TotalDistance) + pset.Kernel(AntiBeach) + pset.Kernel(TidalMotionM2S2K1O1)
...
outputfile = pset.ParticleFile(name = "/science/projects/oceanparcels/output_data/data_Miriam/Results050deg/Results_TrackingGCFES_050deg.nc")
